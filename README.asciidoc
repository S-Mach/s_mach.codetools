...
class or tuple type)
* +ReflectPrintTest+: that prove the output of the generated +ReflectPrint+ for
various common ADT patterns (See +testdata+) in lieu of direct testing of
+BlackboxHelper+ for now.
